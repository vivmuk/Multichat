...
import { fetchModels } from '../services/veniceApi';
      ...
      <Paper elevation={2} sx={{ height: '100%', borderRadius: 3, overflow: 'hidden' }}>
        ...
        <Box sx={{ p: 2 }}>
          <Typography variant="body2" color="text.secondary" sx={{ fontSize: '0.8rem' }}>
            Add your API key in Settings to load models.
          </Typography>
        </Box>
      </Paper>
    );
    ...
    <Paper elevation={2} sx={{ height: '100%', borderRadius: 3, overflow: 'hidden' }}>
      <Box sx={{ p: 2, borderBottom: '1px solid rgba(0, 0, 0, 0.12)' }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5, fontSize: '0.8rem' }}>
          {loading ? 'Loading…' : `${selectedModels.length} / ${availableModels.length} selected`}
        </Typography>
      </Box>
